...
class LawOfLeftoversTest {
	...
	/**
	 * A generated NINE CHAOS puzzle (band SEVEN, seed 0) whose solve applies the technique 5 time(s).
	 * <p>
	...
	private static Puzzle puzzle() {
		return StrategyFixtures.generated(GridSize.NINE, Variant.CHAOS, Difficulty.SEVEN, 0L);
	}
