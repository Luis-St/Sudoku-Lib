...
class XChainTest {
	...
	/**
	 * A generated NINE CHAOS puzzle (band TWELVE, seed 2) whose solve applies the technique 1 time(s).
	 * <p>
	...
	private static Puzzle puzzle() {
		return StrategyFixtures.generated(GridSize.NINE, Variant.CHAOS, Difficulty.TWELVE, 2L);
	}
